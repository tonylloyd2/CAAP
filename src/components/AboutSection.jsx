                ...
                >
                  <CardContent sx={{ p: 4 }}>
                    <Box sx={{ display: 'flex', alignItems: 'center', mb: 3 }}>
                      ...
                      />
                      <Typography variant="h4" component="h3" sx={{ color: '#F8FAFC', fontWeight: 600 }}>
                        Our Mission
                      </Typography>
                    </Box>
                    <Typography
            ...
            >
              ...
              >
                ...
                <Box sx={{ textAlign: 'center', flexShrink: 0 }}>
                  ...
                  >
                    <Typography variant="h3" component="div" sx={{ fontWeight: 700, textAlign: 'center' }}>
                      4+
